...
export const getWallet: Record<string, { walletAddress: string; qrCode: string; network: string, networkFee: number; estimatedTime: string; }> = {
  ...
  "usdt erc(20)": { walletAddress: "0xC4553419724e25b971cc78baA5f0c050Ab37F001", qrCode: '/usdt erc_wallet.jpg', network: 'Ethereum', networkFee: 0.2, estimatedTime: "1–2 mins" },
  "usdt trc(20)": { walletAddress: "TSG9wSYr98oBTJuZjp3QiotcvmvgdoYAXz", qrCode: "/usdt trc_wallet.jpg", network: "Tron", networkFee: 3.0, estimatedTime: "10–20 mins" },
