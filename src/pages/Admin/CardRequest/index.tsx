...
const Index = () => {
    ...
    const { data, isFetching, isLoading, isError, refetch } = GetCardRequests(currentPage.toString(), "20");
    ...
    return (
        <main>
            <p className="mt-4 font-semibold text-neutral-100 text-lg md:text-xl xl:text-2xl">Card Request Table</p>
            {isError ? (
                ...
                <div className="mt-10">
                    <CardTable cardRequests={cardRequests} />
                    {totalPages > 1 && (
