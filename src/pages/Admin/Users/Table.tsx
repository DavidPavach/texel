...
const Table = ({ users }: { users: User[] }) => {
    ...
    return (
        <div className="mt-2 w-full overflow-x-auto">
            <div onClick={togglePending} className={`my-4 text-[10px] md:text-xs xl:text-sm ${pendingKyc ? "bg-primary text-black" : "bg-neutral-600 text-white"} cursor-pointer w-fit rounded-xl px-2 py-1`}>
                Pending KYC
            </div>
