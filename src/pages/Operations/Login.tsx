    ...
    return (
        <main className="bg-lightBlack mx-auto p-6 rounded-xl w-full max-w-xl text-neutral-100">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
                ...
                <button type="submit" disabled={loading} className="bg-primary hover:bg-yellow-600 disabled:opacity-50 py-3 rounded-xl font-semibold text-black transition-colors disabled:cursor-not-allowed">
